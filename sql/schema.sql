...
-- --------------------------------------------------------
-- CREACIÓN DE TABLAS - SOLO ESTRUCTURAS
-- --------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `cuentas_contables` (
  ...
  UNIQUE KEY `uk_codigo_cuenta` (`codigo_cuenta`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
-- Constraints para detalle_compras
...
-- Constraints para detalle_ventas
...
-- Constraints para movimientos_bodega
...
-- Constraints para movimientos_contables
...
-- Insertar datos en modulos_sistema
...
-- Insertar datos en cuentas_contables (PUC Colombiano)
INSERT INTO `cuentas_contables` (`codigo_cuenta`, `nombre_cuenta`, `tipo_cuenta`, `descripcion`) VALUES
('1105', 'Caja', 'Activo', 'Efectivo en caja general'),
('110505', 'Caja General', 'Activo', 'Efectivo en caja principal'),
('1110', 'Bancos', 'Activo', 'Depósitos en entidades financieras'),
('111005', 'Cuenta Corriente', 'Activo', 'Cuenta corriente bancaria'),
('111010', 'Cuenta de Ahorros', 'Activo', 'Cuenta de ahorros'),
('1115', 'Inversiones', 'Activo', 'Inversiones temporales'),
('1305', 'Clientes', 'Activo', 'Cuentas por cobrar a clientes'),
('130505', 'Clientes Nacionales', 'Activo', 'Clientes del país'),
('130510', 'Clientes Internacionales', 'Activo', 'Clientes del exterior'),
('1345', 'Anticipos', 'Activo', 'Anticipos a proveedores'),
('14', 'Inventarios', 'Activo', 'Mercancías y productos'),
('1405', 'Materias Primas', 'Activo', 'Materiales para producción'),
('1410', 'Productos en Proceso', 'Activo', 'Productos en fabricación'),
('1415', 'Productos Terminados', 'Activo', 'Productos listos para venta'),
('1420', 'Mercancías No Fabricadas', 'Activo', 'Mercancías para la venta'),
('1430', 'Bienes en Consignación', 'Activo', 'Mercancías en consignación'),
('1435', 'Inventario en Tránsito', 'Activo', 'Mercancías en transporte'),
('1440', 'Suministros', 'Activo', 'Materiales y suministros'),
('1445', 'Envases y Empaques', 'Activo', 'Materiales de empaque'),
('1450', 'Productos Agrícolas', 'Activo', 'Productos del sector agrícola'),
('1455', 'Animales en Desarrollo', 'Activo', 'Animales en crecimiento'),
('15', 'Propiedades, Planta y Equipo', 'Activo', 'Activos fijos'),
('1510', 'Terrenos', 'Activo', 'Terrenos de propiedad de la empresa'),
('1515', 'Edificaciones', 'Activo', 'Edificios y construcciones'),
('1520', 'Maquinaria y Equipo', 'Activo', 'Maquinaria y equipo de producción'),
('1525', 'Equipo de Oficina', 'Activo', 'Muebles y enseres de oficina'),
('1530', 'Vehículos', 'Activo', 'Vehículos de transporte'),
('1535', 'Equipo de Computación', 'Activo', 'Equipos de computación y comunicación'),
('1540', 'Depreciación Acumulada', 'Activo', 'Depreciación acumulada de activos fijos'),
('21', 'Obligaciones Financieras', 'Pasivo', 'Préstamos y obligaciones'),
('2105', 'Bancos Nacionales', 'Pasivo', 'Préstamos de bancos nacionales'),
('22', 'Proveedores', 'Pasivo', 'Cuentas por pagar a proveedores'),
('2205', 'Proveedores Nacionales', 'Pasivo', 'Proveedores del país'),
('2210', 'Proveedores Internacionales', 'Pasivo', 'Proveedores del exterior'),
('23', 'Cuentas por Pagar', 'Pasivo', 'Otras cuentas por pagar'),
('2335', 'Acreedores Varios', 'Pasivo', 'Otros acreedores diversos'),
('24', 'Impuestos por Pagar', 'Pasivo', 'Obligaciones tributarias'),
('2408', 'IVA por Pagar', 'Pasivo', 'IVA causado por pagar'),
('2412', 'Retención en la Fuente', 'Pasivo', 'Retención en la fuente por pagar'),
('25', 'Obligaciones Laborales', 'Pasivo', 'Prestaciones sociales'),
('2505', 'Salarios por Pagar', 'Pasivo', 'Salarios pendientes de pago'),
('2510', 'Prestaciones Sociales', 'Pasivo', 'Prestaciones sociales por pagar'),
('26', 'Diferidos', 'Pasivo', 'Ingresos diferidos'),
('2605', 'Ingresos Diferidos', 'Pasivo', 'Ingresos recibidos por anticipado'),
('31', 'Capital Social', 'Patrimonio', 'Aportes de los socios'),
('3105', 'Capital Autorizado', 'Patrimonio', 'Capital social autorizado'),
('3110', 'Capital por Suscribir', 'Patrimonio', 'Capital pendiente de pago'),
('3115', 'Capital Pagado', 'Patrimonio', 'Capital efectivamente pagado'),
('3120', 'Aportes Sociales', 'Patrimonio', 'Aportes de los accionistas'),
('33', 'Reservas', 'Patrimonio', 'Reservas de la empresa'),
('3305', 'Reserva Legal', 'Patrimonio', 'Reserva legal obligatoria'),
('3310', 'Reservas Ocasionales', 'Patrimonio', 'Reservas voluntarias'),
('3315', 'Reserva para Reposición', 'Patrimonio', 'Reserva para activos'),
('34', 'Resultados del Ejercicio', 'Patrimonio', 'Utilidades o pérdidas'),
('3405', 'Utilidad del Ejercicio', 'Patrimonio', 'Ganancias del período'),
('3410', 'Pérdida del Ejercicio', 'Patrimonio', 'Pérdidas del período'),
('36', 'Resultados de Ejercicios Anteriores', 'Patrimonio', 'Resultados acumulados'),
('41', 'Ingresos Operacionales', 'Ingreso', 'Ingresos de actividades principales'),
('4135', 'Ventas', 'Ingreso', 'Ingresos por venta de productos'),
('413505', 'Ventas Productos Terminados', 'Ingreso', 'Ventas de productos fabricados'),
('413510', 'Ventas Mercancías No Fabricadas', 'Ingreso', 'Ventas de mercancías compradas'),
('413515', 'Ventas Servicios', 'Ingreso', 'Ventas de servicios prestados'),
('4175', 'Devoluciones en Ventas', 'Ingreso', 'Devoluciones y rebajas sobre ventas'),
('42', 'Ingresos No Operacionales', 'Ingreso', 'Otros ingresos'),
('4210', 'Financieros', 'Ingreso', 'Ingresos por inversiones'),
('4215', 'Otros Ingresos', 'Ingreso', 'Otros ingresos diversos'),
('61', 'Costos de Ventas', 'Costo', 'Costos asociados a las ventas'),
('6135', 'Costo de Ventas', 'Costo', 'Costo de mercancías vendidas'),
('613505', 'Costo Ventas Productos Terminados', 'Costo', 'Costo de productos vendidos'),
('613510', 'Costo Ventas Mercancías No Fabricadas', 'Costo', 'Costo de mercancías vendidas'),
('613515', 'Costo Ventas Servicios', 'Costo', 'Costo de servicios prestados'),
('6175', 'Devoluciones en Costos', 'Costo', 'Devoluciones en costos de ventas'),
('62', 'Compras', 'Costo', 'Compras de mercancías'),
('6205', 'Compras', 'Costo', 'Compras de inventarios'),
('620505', 'Compras Mercancías', 'Costo', 'Compras para la venta'),
('620510', 'Compras Materias Primas', 'Costo', 'Compras para producción'),
('6255', 'Devoluciones en Compras', 'Costo', 'Devoluciones a proveedores'),
('51', 'Gastos de Operación', 'Gasto', 'Gastos de administración y ventas'),
('5105', 'Gastos de Personal', 'Gasto', 'Salarios y prestaciones'),
('510505', 'Salarios', 'Gasto', 'Remuneraciones al personal'),
('510510', 'Prestaciones Sociales', 'Gasto', 'Prestaciones legales'),
('5110', 'Honorarios', 'Gasto', 'Honorarios a terceros'),
('5115', 'Impuestos', 'Gasto', 'Impuestos y tasas'),
('5120', 'Arrendamientos', 'Gasto', 'Alquileres y arrendamientos'),
('5125', 'Servicios Públicos', 'Gasto', 'Agua, luz, teléfono'),
('5130', 'Mantenimiento', 'Gasto', 'Mantenimiento de equipos'),
('5135', 'Transporte', 'Gasto', 'Fletes y transportes'),
('5140', 'Seguros', 'Gasto', 'Primas de seguros'),
('5145', 'Comisiones', 'Gasto', 'Comisiones sobre ventas'),
('5150', 'Publicidad', 'Gasto', 'Gastos de publicidad'),
('5155', 'Gastos de Viaje', 'Gasto', 'Viáticos y viajes'),
('5160', 'Papelería y Útiles', 'Gasto', 'Materiales de oficina'),
('5165', 'Depreciación', 'Gasto', 'Depreciación de activos'),
('5195', 'Otros Gastos', 'Gasto', 'Otros gastos operacionales'),
('52', 'Gastos Financieros', 'Gasto', 'Gastos por intereses'),
('53', 'Gastos Extraordinarios', 'Gasto', 'Gastos no operacionales'),
('81', 'Cuentas de Orden Deudoras', 'Orden', 'Contingencias deudoras'),
('82', 'Cuentas de Orden Acreedoras', 'Orden', 'Contingencias acreedoras');
...
-- Insertar datos en movimientos_bodega
...
-- Insertar datos en permisos_roles
...
-- --------------------------------------------------------
-- Finalización del volcado de datos para la tabla `permisos_roles`
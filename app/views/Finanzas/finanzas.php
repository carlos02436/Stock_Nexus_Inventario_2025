...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom"
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group me-2">
            <a href="index.php?page=pagos" class="btn btn-outline-primary">Pagos</a>
            <a href="index.php?page=balance" class="btn btn-outline-primary">Balance</a>
        </div>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-header">
                <h6 class="m-0 font-weight-bold text-primary">Resumen por Método de Pago</h6>
            </div>
            <div class="card-body">

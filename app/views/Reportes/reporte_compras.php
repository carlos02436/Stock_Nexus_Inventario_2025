...
<div class="container-fluid px-4 mb-5 text-white" style="margin-top:180px;">
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-4 border-bottom border-light">
        ...
        <div class="btn-toolbar mb-2 mb-md-2">
            ...
            <a href="index.php?page=generar_pdf_compras&tipo=compras&fecha_inicio=<?= htmlspecialchars($fecha_inicio) ?>&fecha_fin=<?= htmlspecialchars($fecha_fin) ?>" class="boton2 me-2 text-decoration-none">
            ...
            <a href="index.php?page=generar_excel_compras&tipo=compras&fecha_inicio=<?= htmlspecialchars($fecha_inicio) ?>&fecha_fin=<?= htmlspecialchars($fecha_fin) ?>" class="boton1 me-2 text-decoration-none">
